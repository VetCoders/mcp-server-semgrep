...
if (!semgrepToken) {
  console.error('Missing SEMGREP_APP_TOKEN. Export it in your shell before running this script.');
  process.exit(1);
}

// Spawn the server process with Semgrep token from the environment
